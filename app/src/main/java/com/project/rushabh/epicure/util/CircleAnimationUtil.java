package com.project.rushabh.epicure.util;
...
public class CircleAnimationUtil
{
    ...
    public CircleAnimationUtil setMoveDuration(@SuppressWarnings("SameParameterValue") int duration)
    {
    ...
    private Bitmap drawViewToBitmap(View view, int width, int height)
    {
        ...
        Drawable drawable = new BitmapDrawable(view.getContext().getResources(), dest);
